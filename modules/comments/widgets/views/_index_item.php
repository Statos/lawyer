...
<div class="comment c-t<?=$comment->ctype ?> <?php if(false && $comment->state == 0): ?> comment-not-approved <?php endif; ?>" comment_id="<?=$comment->id ?>">
    ...
    <div class="comment-info row">
        <div class="col-md-9">
            ...
            <div class="c-not-approved">
                <a class="noajax" href="/comments/default/view?id=<?=$comment->id ?>">Перейти к модерации комментария</a>
            </div>
            <?php endif; */ ?>
        ...
        <div class="col-lg-3">
            ...
            <?php if($options['answers'] || !Yii::$app->user->isGuest): //TODO?>
