...
class UploadHandler
{
    ...
    protected $error_messages = array(
        1 => 'Размер файла слишком велик',//'The uploaded file exceeds the upload_max_filesize directive in php.ini',
        2 => 'Размер файла слишком велик',//'The uploaded file exceeds the MAX_FILE_SIZE directive that was specified in the HTML form',
